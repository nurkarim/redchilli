												...
												<table id="example1" class="table table-bordered table-responsive-xl table-hover display">
													...
													<tbody>
														...
														<tr style="max-height: 10px!important">
															...
															<td>{{ $category->name }}</td>
															<td>{{ $category->note }}</td>
															<td><button class="btn btn-sm btn-danger">Delete</button> | <button data-toggle="modal" data-target="#modal" class="btn btn-primary btn-sm" onclick="loadModal('{{route('categories.edit',$category->id)}}')">Edit</button></td>
														</tr>
														@endforeach
