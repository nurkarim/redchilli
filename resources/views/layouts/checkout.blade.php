						  ...
						  <div class="card-body">
							...
							<form method="POST" action="{{ route('checkouts.store') }}">
							  ...
							  <div class="form-group">
							    ...
							    <input type="text" name="delivery_address" required="" class="form-control" placeholder="Enter your correct address" value="@if(Session::has('delivery_address')) {{Session::get('delivery_address')}} @else {{ old('delivery_address') }} @endif">
							  </div>
